...
This whole repository exists because of a thought experiment about the opposite of virtue. [eigenslur.org](https://eigenslur.org/) defined the eigenslur as "the principal component of offense, the eigenvector of linguistic cruelty," and argued from basic linear algebra that it must exist: "in any finite vocabulary projected onto any axis there is a point that projects further than every other point." The site also made a genuinely sharp prediction about what the extreme point would look like: "It might not be a word. Tokenizers don't care about meaning." The maximally offensive location in embedding space might be a byte sequence no human mouth ever shaped. The site never ran the computation, and [the video](https://www.tiktok.com/@zach.zeta.s/video/7640238795803151646) that pointed us to it flipped the question toward human flourishing instead, which became the main study in this repo.
